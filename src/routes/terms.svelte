<svelte:head>
  <title>Since / Terms &amp; Conditions</title>
</svelte:head>

<div class="py-8 mx-auto prose">
  ...
  <p>
    ...
    rights related to it, still belong to Ruslan Doga.
  </p>
  <p>
    The Since app&nbsp;has no tolerance for objectionable&nbsp;adult and NSFW
    content, abusive users and bullying behaviour. Such instances may be
    punished with immediate bans.
  </p>
  <p>
    Ruslan Doga is committed to ensuring that the app is as useful and efficient
  ...
  <p>
    The Since app stores and processes personal data that you have provided to
    us, in order to provide my Service. It’s your responsibility to keep your
    ...
    features and it could mean that the Since app won’t work properly or at all.
  </p>
  <p>
    You should be aware that there are certain things that Ruslan Doga will not
    ...
    provided by your mobile network provider, but Ruslan Doga cannot take
  ...
  <p>
    Along the same lines, Ruslan Doga cannot always take responsibility for the
    ...
    Service, Ruslan Doga cannot accept responsibility.
  </p>
  <p>
    With respect to Ruslan Doga’s responsibility for your use of the app, when
    ...
    available to you. Ruslan Doga accepts no liability for any loss, direct or
  ...
  <p>
    ...
    to download the updates if you want to keep using the app. Ruslan Doga does
    not promise that it will always update the app so that it is relevant to you
    and/or works with the iOS version that you have installed on your device.
  ...
  <p>These terms and conditions are effective as of 2021-01-26</p>
  <p><strong>Contact Us</strong></p>
  <p>
    If you have any questions or suggestions about my Terms and Conditions, do
    not hesitate to contact me at <a href="mailto:kindly@getsince.app"
      >kindly@getsince.app</a
    >.
  </p>
</div>
